    ...
    <section className="w-full">
      ...
      <main className="w-10/12 mx-auto">
        <div className="flex justify-start">
          <div className="flex flex-col items-center md:justify-start md:flex-row gap-5 -mt-56 md:-mt-16">
            <div className="relative z-10 w-64 md:w-80 h-72 md:h-80 rounded-2xl overflow-hidden shadow-black shadow-2xl">
      ...
      <footer className="w-10/12 mt-16 mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="flex flex-col items-center mx-5 md:mx-0 p-5 text-center bg-white bg-opacity-10 hover:bg-opacity-5 rounded-2xl">
